...
public class PowerSpectrum {
	...
	/**
	 * G�r power spectrum av datan specifierat enligt alpha, windowName och numberParts
	 * @param yValues Inputdata
	 * @param alpha V�rdet p� alpha i filtret
	 * @param windowName Namnet p� f�nstret som objektet initialiseras med.
     * @param numberParts Antal delar som datan splittas upp i f�r spectrum
	 */
    ...
    /**
     * S�tter initiala v�rden p� datal�ngd, antal delar och datav�rden
    ...
    /**
     * @return den reella componenten av v�rt spektrum
     */
